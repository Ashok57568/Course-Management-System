...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void search() throws SQLException, ClassNotFoundException {
        try{
            ...
            Person person = personDao.findOne(em, pass);
            if (person != null) {
    ...
    private void start() throws SQLException, ClassNotFoundException{
        ...
        String pass = password.getText();
        Person person = personDao.findOne(emailUser, pass);
        if(person!=null){
            setVisible(false);
            Dashboard dash =  new Dashboard(person);
            dash.setVisible(true);
        }else{
            JOptionPane.showMessageDialog(this, "Error input. Please try again.", "Login Error", JOptionPane.ERROR_MESSAGE);
        }
    }
